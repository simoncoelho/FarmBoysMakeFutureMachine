...
static volatile int binaryImage[4], derError[2], intError, IR_PLANT, IR_PIN, BOARD_DIRECTION;
  ...
  /*
   ...
   pause(2000);
	...
	while (1) {
      ...
      print("Left IR Sensor:  %f%c \n", adc_volts(IR_PIN_LEFT));
      print("Right IR Sensor: %f%c \n",  adc_volts(IR_PIN_RIGHT));
